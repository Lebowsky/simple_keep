...
class SeriesItemModel(BaseModel):
    ...
    property_id: Optional[str] = Field(default='', alias='id_properties')
    warehouse_id: Optional[str] = Field(default='', alias='id_warehouse')
    cell_id: Optional[str] = Field(default='', alias='cell')
    name: str
    number: str
